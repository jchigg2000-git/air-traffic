...
**Status:** plan-only. No code exists yet (`internal/gateway` is reserved, not built). Build on demand — see [§1 Why](#1-why-were-building-this-grounding-in-the-design-rationale) and design doc §15.
