...
<div class="smark"><img src="../web/public/icons/air-traffic-icon-512.png"/><span class="lab">The problem</span></div>
...
<div class="smark"><img src="../web/public/icons/air-traffic-icon-512.png"/><span class="lab">The control catalog</span></div>
...
<div class="smark"><img src="../web/public/icons/air-traffic-icon-512.png"/><span class="lab">How strong is "enforced"?</span></div>
...
<div class="smark"><img src="../web/public/icons/air-traffic-icon-512.png"/><span class="lab">Architecture</span></div>
...
```mermaid
graph LR
  admin["Admin<br/>Rigor Console / Policy Editor"] --> at["Air-Traffic<br/>control plane + config distributor"]
  at -->|"push managed-settings.json<br/>+ read back (claude doctor)"| cc["Claude Code<br/>managed settings"]
  at -->|"AI Controls + branch-protection /<br/>rulesets API"| gh["GitHub Copilot<br/>org policies + repo rules"]
  cc -.->|"effective state"| at
  gh -.->|"audit + metrics API"| at
  at --> obs["Normalized observability<br/>ops-observation-batch/v1 · OTel GenAI"]
  obs --> siem["SIEM / Langfuse<br/>(optional export)"]
```
...
<div class="smark"><img src="../web/public/icons/air-traffic-icon-512.png"/><span class="lab">The artifacts Air-Traffic emits</span></div>
...
<div class="smark"><img src="../web/public/icons/air-traffic-icon-512.png"/><span class="lab">Executive Flight Deck — scoped to the two platforms</span></div>
...
<div class="smark"><img src="../web/public/icons/air-traffic-icon-512.png"/><span class="lab">The board-level outcome</span></div>
